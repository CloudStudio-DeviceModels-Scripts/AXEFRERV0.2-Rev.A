...
# Parsing + Configuration Script – AXE FRER V 0.2 - Rev. A

This **Parsing + Configuration** script is designed for the **AXE FRER V 0.2** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – AXE FRER V 0.2 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **AXE FRER V 0.2** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
